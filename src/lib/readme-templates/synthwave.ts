...
<div align="center">
  <!-- Synthwave Header -->
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=2,2,5,30&height=180&section=header&text=${
      encodeURIComponent(userProfile.name || userProfile.login)
    }&desc=${
      encodeURIComponent("< " + (userProfile.bio || "Developer") + " >")
    }&fontSize=30&descSize=20&fontColor=ff2e97&animation=twinkling" />
